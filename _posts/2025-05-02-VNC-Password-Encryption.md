...
tags: [powershell, vnc, password]     # TAG names should always be lowercase
mermaid: true
---
The following post runs through the process of writing VNC password encryption and decryption scripts.
